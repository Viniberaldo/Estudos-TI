...
public class Main {
	...
	public static void main(String[] args) {
		...
		inicializaSistemaBancario(); // criando algumas contas e clientes fictcios
		...
		while (continua){
			...
			case 2:
				...
				if(conta != null)
					...
					System.out.println("Conta no encontrado!");
	...
	/**
	 * Imprime menu de opes do nosso sistema bancrio
	 */
	...
	/**
	 * Mtodo que cria e insere algumas contas e clientes no sistema do banco,
	 * apenas para realizao de testes manuais atravs do mtodo main acima.
	 */
