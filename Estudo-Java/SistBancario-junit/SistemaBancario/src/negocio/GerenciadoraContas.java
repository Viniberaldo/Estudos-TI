...
/**
 * Classe de negcio para realizar operaes sobre as contas do banco.
...
public class GerenciadoraContas {
	 ...
	 * @return a conta pesquisada ou null, caso no seja encontrada
	 */
	 ...
	 * @return true se a conta foi removida. False, caso contrrio.
	 */
	...
	/**
	 * Informa se uma determinada conta est ativa ou no.
	 * @param idConta ID da conta cujo status ser verificado
	 * @return true se a conta est ativa. False, caso contrrio. 
	 */
	 ...
	 * Caso no haja saldo suficiente, o valor no ser transferido.
	 * 
	 * @param idContaOrigem conta que ter o valor deduzido
	 * @param valor valor a ser transferido
	 * @param idContaDestino conta que ter o valor acrescido
	 * @return true, se a transferncia foi realizada com sucesso.
	 */
